...
<div align='center' class='container' >
    ...
    <li class=\"active\"><a data-toggle=\"tab\" href= \"#home\"> تفاصيل تقييم الشعبة <i class=\"fa fa-arrow-circle-left\"></i>
    </a></li>
	        ...
	        function GetTotalDay($date55)
{
  ...
  $sql1 = "select * from reports1  where D_sector ='$name' ";
...
$row411 = mysql_fetch_array($result411);
     ...
     $query753 = "SELECT D_sector, SUM(Number)   FROM reports1 where  D_sector ='$name' GROUP BY " .   D_sector . " ";
