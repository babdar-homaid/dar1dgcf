        ...
        <div class="modal-body">
            ...
            <div class="col-sm-12 col-md-6 offset-sm-12">
                ...
                <div class="form-group">
                    ...
                    @error('answer2') <span class="error text-danger">{{ $message }}</span> @enderror
            ...
            <div class="col-sm-12 col-md-6 offset-sm-12">
                ...
                <div class="form-group">
                    ...
                    @error('answer3') <span class="error text-danger">{{ $message }}</span> @enderror
                ...
                <div class="form-group">
                    ...
                    @error('answer4') <span class="error text-danger">{{ $message }}</span> @enderror
            ...
            <div class="col-sm-12 col-md-12 offset-sm-12">
                ...
                <div class="form-group">
                    ...
                    @error('trues') <span class="error text-danger">{{ $message }}</span> @enderror
