        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-sm-4 col-md-4"> <a href="/student/first/{{$User->Student_ID}}"><button type="button " class="btn btn-outline-success">درجات الفصل الأول</button></a></div>
                        <div class="col-sm-4 col-md-4"><a href="/student/second/{{$User->Student_ID}}"> <button type="button " class="btn btn-outline-success">درجات الفصل الثاني</button></a></div>
