...
<form method="POST" action="studentـregistration_2">
    {{ csrf_field() }}
    <input type="hidden" class="form-control" value="{{Auth::user()->id}}" name="user_id" placeholder="الحقل مطلوب" id="text" required autocomplete="name" required autocomplete="name" >
...
<div class="row">
    ...
    <div class="col-sm-12 col-md-3 offset-sm-12"><div class="form-group">
        ...
        <option value="{{$values->Nationalty_Id}}">{{$values->Nationalty_Name}}</option>
        @endforeach
      </select>
      </div></div>
