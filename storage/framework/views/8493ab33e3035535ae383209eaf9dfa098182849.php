...
<button type="button" class="btn btn-primary col-md-2 col-sm-12" data-toggle="modal" data-target="#exampleModal">
    بحث
  </button>
  ...
  <?php if($sum++): ?>
    ...
    <td><?php echo e($item->user->id); ?></td>
      ...
      <td>
            ...
            <?php echo e($item->name); ?> <?php echo e($item->user->email); ?>
...
<?php /**PATH /Users/bndralsymy/Desktop/up/dar/resources/views/register/search-user.blade.php ENDPATH**/ ?>