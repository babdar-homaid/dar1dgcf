...
<script src="<?php echo e(asset('js/dropzone.js')); ?>" defer></script>
...
<link href="<?php echo e(asset('css/app.css')); ?>" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css?family=Cairo&display=swap" rel="stylesheet">
     <link href="<?php echo e(asset('fontawesome-free-5.15.1-web\css\all.css')); ?>" rel="stylesheet">
     <link rel="stylesheet" href="https://cdn.rtlcss.com/bootstrap/v4.5.3/css/bootstrap.min.css" integrity="sha384-JvExCACAZcHNJEc7156QaHXTnQL3hQBixvj5RV5buE7vgnNEzzskDtx9NQ4p6BJe" crossorigin="anonymous">
<script src="https://kit.fontawesome.com/a076d05399.js"></script>

<script src="<?php echo e(asset('https://cdn.jsdelivr.net/npm/gasparesganga-jquery-loading-overlay@2.1.6/dist/loadingoverlay.min.js')); ?>" defer></script>

<script src="<?php echo e(asset('js/cood.js')); ?>" defer></script>
...
<?php if(Auth::user()and Auth::user()->id==1 or Auth::user()->id==3 or Auth::user()->id==35 or Auth::user()->id==36): ?>
...
<?php if(Auth::user()and Auth::user()->id==1): ?>
...
<a class="nav-item nav-link" href="/Distributionـofـcommittees/<?php echo e(Auth::user()->Requestـstatus); ?>">
    <i class='far fa-address-card' ></i> عرض المتقدمين </a>

    <a class="nav-item nav-link" href="/print_all/<?php echo e(Auth::user()->Requestـstatus); ?>">
        <i class='fas fa-print' ></i> طباعة الاستمارات </a>

        <a class="nav-item nav-link" href="/word/<?php echo e(Auth::user()->Requestـstatus); ?>">
            <i class='far fa-file-word' ></i> تصدير الاسماء </a>

            <a class="nav-item nav-link" href="/student_Export_pdf/<?php echo e(Auth::user()->Requestـstatus); ?>" target="_blank">
                <i class='far fa-file-pdf' ></i> تصدير الاسماء </a>
<?php endif; ?>
...
<?php echo $file = "يتصفح الموقع الآن";
...
<?php /**PATH /Users/bndralsymy/Desktop/up/darallhadith1.com/resources/views/layouts/app.blade.php ENDPATH**/ ?>