        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-sm-4 col-md-4"> <a href="/student/first/<?php echo e($User->Student_ID); ?>"><button type="button " class="btn btn-outline-success">درجات الفصل الأول</button></a></div>
                        <div class="col-sm-4 col-md-4"><a href="/student/second/<?php echo e($User->Student_ID); ?>"> <button type="button " class="btn btn-outline-success">درجات الفصل الثاني</button></a></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bndralsymy/Desktop/up/dar/resources/views/exam/completion_Student.blade.php ENDPATH**/ ?>