...
<div class="col-md-12">
<div class="card">
<div   id ='font_news' class="card-header">الطلاب الجدد المرحلة <?php echo e($id); ?>  <?php echo $__env->make('register.searchuser', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
...
<?php if($sum++): ?>
  ...
  <td><?php echo e($sum); ?> </td>
    ...
    <td>
        <?php if($item->hndl1==1): ?><a href="<?php echo e(route('sendsms', ['id'=>$item->id])); ?>"><button type="button" class="btn btn-warning"> الطلب انتظار </button> <?php endif; ?>
       <?php if($item->hndl1==2): ?>  <a href="<?php echo e(route('addok', ['id'=>$item->id,'name'=>$id])); ?>"> <button type="button" class="btn btn-success">الطلب مقبول </button> </a> <?php endif; ?>
    <?php if($item->hndl1==3): ?><a   title="السبب" data-toggle="popover" data-placement="top" data-content="<?php echo e($item->note); ?>"> <button type="button" class="btn btn-danger">الطلب مرفوض  </button></a> <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bndralsymy/Desktop/up/dar/resources/views/register/new_students.blade.php ENDPATH**/ ?>