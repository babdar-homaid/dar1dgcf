...
<?php if($value->hndl1==1): ?><div class="container alert alert-warning"><?php endif; ?>
    <?php if($value->hndl1==2): ?><div class="container alert alert-success"><?php endif; ?>
        <?php if($value->hndl1==3): ?><div class="container alert alert-danger"><?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bndralsymy/Desktop/up/dar/resources/views/register/New_student_information.blade.php ENDPATH**/ ?>