...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <td><a href="/question/addQ/<?php echo e($id); ?>"><button type="button" class="btn btn-success btn-lg btn-block">ضع الإسئلة</button></a></td>
            <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bndralsymy/Desktop/up/dar/resources/views/question/add.blade.php ENDPATH**/ ?>