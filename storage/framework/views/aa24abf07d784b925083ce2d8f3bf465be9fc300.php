...
<?php if($sum++): ?><?php endif; ?>
          ...
          <td><?php echo e($item->Item_High_Degree_1); ?></td>
            ...
            <td>
                ...
                <?php echo e($item->Degree_Stage_2); ?>
        ...
        <tr>
            ...
            <?php if($Chapter_Degree+=$item->Degree_Stage_2): ?><?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bndralsymy/Desktop/up/dar/resources/views/exam/Chapter_final.blade.php ENDPATH**/ ?>