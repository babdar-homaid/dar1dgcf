...
break; 
            ...
            $query_1 = "  SELECT *  FROM reports  WHERE  `daten` = '$daten' and admin ='$admincp' and D_sector='$D_sector'  and Thread='$date3e' ORDER BY id DESC";
...
لايمكن تكرار تقييم الشعبة والسلوك ذاته مرة أخرى إلا بعد أسبوع   </div>'; exit; }
 @$query = "INSERT INTO `reports` (`id`, `xd`, `text1`, `Number`, `datee`, `Thread`, `Transfer`, `What`, `admin`, `date1`, `daten`, `Today`,dateR,D_sector) VALUES
  (NULL, 'إنتظار', 'text1', '$date1e', '$date20', '$date3e', '$Transfer','6', '$admincp', NULL, SYSDATE() , '$nameday','$daten','$D_sector');
";
...
شكرا لك على التقييم تم استلام التقييم بنجاح <i class='fa fa-heart-o' style='color:red'></i>  </div>
<?php
