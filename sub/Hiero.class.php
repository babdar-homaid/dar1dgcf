...
class Hiero
{
    protected $language = 'Hiero';

    /**
     * "str2hiero" method input charset
     * @var String     
     */         
    public $str2hieroInput = 'utf-8';
    ...
    */
                                    ...
                                    $red = null, $green = null, $blue = null)
    {
        ...
        if ($lang != 'ar' && $this->language == 'phoenician') {
            include dirname(__FILE__).'/Transliteration.class.php';
        ...
        foreach ($chars as $char) {
            ...
            if (file_exists(dirname(__FILE__)."/{$this->language}/$char.gif")) {
                list($width, $height) = getimagesize(dirname(__FILE__)."/{$this->language}/$char.gif");
            } else {
                $width  = MAXW;
                $height = MAXH;
            }
        ...
        foreach ($chars as $char) {
            ...
            $filename = dirname(__FILE__)."/{$this->language}/$char.gif";
