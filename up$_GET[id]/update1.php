...
break; 
    ...
    $What1 = GetTotalDay($daten);

            $query_1 = "  SELECT *  FROM reports1  WHERE  `daten` = '$daten' and admin ='$admincp' and D_sector='$D_sector'  and Thread='$date3e'";
$result_1 = mysql_query ($query_1)
  or die ("Query failed42453245");
$line1 = mysql_fetch_object($result_1);
            echo   $What = $line1->What;
               $id5 = $line1->id;

  if ($What > $What1 and $id5>=1 ){
...
لا تكرار تقييم الشعبة والسلوك ذاته مرة أخرى إلا بعد أسبوع   </div>'; exit; }
 @$query = "INSERT INTO `reports1` (`id`, `xd`, `text1`, `Number`, `datee`, `Thread`, `Transfer`, `What`, `admin`, `date1`, `daten`, `Today`,dateR,D_sector) VALUES
  (NULL, 'إنتظار', 'text1', '$date1e', '$date20', '$date3e', '$Transfer',' 6', '$admincp', NULL, SYSDATE() , '$nameday','$date20e','$D_sector');
";
