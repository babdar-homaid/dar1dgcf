...
class ArNumbers {
     ...
     function ArNumbers(){
        ...
        $this->individual[1][1] = 'احدى';
        $this->individual[1][2] = 'واحدة';

        $this->individual[2][1][1] = 'اثنتان';
        $this->individual[2][1][2] = 'اثنين';
        $this->individual[2][2][1] = 'اثنتان';
        $this->individual[2][2][2] = 'اثنتين';
        ...
        $this->individual[11][1] = 'احدى عشر';
        $this->individual[11][2] = 'إحدى عشرة';

        $this->individual[12][1][1] = 'اثنا عشر';
        $this->individual[12][1][2] = 'اثني عشر';
        $this->individual[12][2][1] = 'اثنتا عشرة';
        $this->individual[12][2][2] = 'اثنتي عشرة';
          ...
          for($i=$blocks_num; $i>=0; $i--){
              ...
              if($text){
                 if($number == 1 && $i != 0){
                    ...
                    $text .= '&nbsp; درجات'.$this->complications[$i][3];
                 }else{
                    $text .= '&nbsp;درجة'.$this->complications[$i][4];
                 }
