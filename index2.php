...
$s=0;
   ...
   $query121 = "UPDATE D_sector SET `su` = '0' ,nsb = '0' ";
...
<div align='center' class='container' >
    ...
    <li class=\"active\"><a data-toggle=\"tab\" href= \"#home\"> تقييم الشعب     <i class=\"fa fa-arrow-circle-left\"></i>
    </a></li>
...
";
 ...
 $query1 = "SELECT Number, SUM(Number)  FROM  reports1  LIMIT 5 ";
$result411 = mysql_query($query1);
$row411 = mysql_fetch_array($result411);



     $query753 = "SELECT D_sector,daten, SUM(Number)   FROM reports1   GROUP BY  " .   D_sector . " ";
...
while ($row411 = mysql_fetch_array($result411)){
 ...
 $ns=$sm/$NMB*100;
  ...
  $query = "UPDATE D_sector 	SET	su = $sm ,nsb=$ns WHERE name = '$na'";
$query1 = mysql_query($query) or die("Query failed");
   ...
   $query10 = "SELECT * FROM  D_sector   ORDER BY su DESC  LIMIT 5";
...
echo "
		...
		<tr>
				...
				<td  ><a href='search6.php?id=$name' >$smm &nbsp; </td>
