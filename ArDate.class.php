...
class ArDate
{
    ...
    public function date($format, $timestamp, $outputCharset = null, $correction = 0, $main = null)
    {
        ...
        if ($this->_mode == 1) {
            ...
            $hj_txt_month[2] = '’›—';
            $hj_txt_month[3] = '—»Ì⁄ «·√Ê·';
            $hj_txt_month[4] = '—»Ì⁄ «·À«‰Ì';
            $hj_txt_month[5] = 'Ã„«œÏ «·√Ê·Ï';
            $hj_txt_month[6] = 'Ã„«œÏ «·À«‰Ì…';
            $hj_txt_month[7] = '—Ã»';
            $hj_txt_month[8] = '‘⁄»«‰';
            $hj_txt_month[9] = '—„÷«‰';
            $hj_txt_month[10] = '‘Ê«·';
            $hj_txt_month[11] = '–Ê «·ﬁ⁄œ…';
            $hj_txt_month[12] = '–Ê «·ÕÃ…';
    ...
    private function _en2ar($str)
    {
        ...
        if ($this->_mode == 2) {
            ...
            array_push($replacements, '√»—Ì·');
            array_push($patterns, 'may');
            array_push($replacements, '„«ÌÊ');
            array_push($patterns, 'june');
            array_push($replacements, 'ÌÊ‰ÌÊ');
            array_push($patterns, 'july');
            array_push($replacements, 'ÌÊ·ÌÊ');
            array_push($patterns, 'august');
            array_push($replacements, '√€”ÿ”');
            ...
            array_push($replacements, '”» „»—');
            array_push($patterns, 'october');
            array_push($replacements, '√ﬂ Ê»—');
            array_push($patterns, 'november');
            array_push($replacements, '‰Ê›„»—');
            array_push($patterns, 'december');
            array_push($replacements, 'œÌ”„»—');
        } elseif ($this->_mode == 4) {
            array_push($patterns, 'january');
            array_push($replacements, 'ﬂ«‰Ê‰ À«‰Ì/Ì‰«Ì—');
            array_push($patterns, 'february');
            array_push($replacements, '‘»«ÿ/›»—«Ì—');
            array_push($patterns, 'march');
            array_push($replacements, '¬–«—/„«—”');
            array_push($patterns, 'april');
            array_push($replacements, '‰Ì”«‰/√»—Ì·');
            array_push($patterns, 'may');
            array_push($replacements, '√Ì«—/„«ÌÊ');
            array_push($patterns, 'june');
            array_push($replacements, 'Õ“Ì—«‰/ÌÊ‰ÌÊ');
            array_push($patterns, 'july');
            array_push($replacements, ' „Ê“/ÌÊ·ÌÊ');
            array_push($patterns, 'august');
            array_push($replacements, '¬»/√€”ÿ”');
            array_push($patterns, 'september');
            array_push($replacements, '√Ì·Ê·/”» „»—');
            array_push($patterns, 'october');
            array_push($replacements, ' ‘—Ì‰ √Ê·/√ﬂ Ê»—');
            array_push($patterns, 'november');
            array_push($replacements, ' ‘—Ì‰ À«‰Ì/‰Ê›„»—');
            array_push($patterns, 'december');
            array_push($replacements, 'ﬂ«‰Ê‰ √Ê·/œÌ”„»—');
        } elseif ($this->_mode == 5) {
            array_push($patterns, 'january');
            array_push($replacements, '√Ì «·‰«—');
            array_push($patterns, 'february');
            ...
            array_push($replacements, '‰«’—');
            array_push($patterns, 'august');
            array_push($replacements, 'Â«‰Ì»«·');
            array_push($patterns, 'september');
            array_push($replacements, '«·›« Õ');
            array_push($patterns, 'october');
            array_push($replacements, '«· „Ê—');
            array_push($patterns, 'november');
            array_push($replacements, '«·Õ—À');
            array_push($patterns, 'december');
            array_push($replacements, '«·ﬂ«‰Ê‰');
        }
