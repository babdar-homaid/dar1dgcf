...
$query = mysql_query("select * from reports where admin ='$admincp'");
...
$sql1 = "select * from reports where admin ='$admincp' ORDER BY `id` DESC  LIMIT " . ($pager->page - 1) * $perpage .
    "," . $perpage;
...
$cp11="";
  ...
  if ($xd==1 or !$xd  ){
    ...
    echo "
		...
		<tr>
				<td id='max'>$s&nbsp; </td>
								<td > <a href='D_Note3.php?id=$id' > $D_sector&nbsp; </td>
