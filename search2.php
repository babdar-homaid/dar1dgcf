...
تقييم الطالبات  من تاريح $Thread1 إلى تاريخ $Thread2
...
$row411 = mysql_fetch_array($result411);
     ...
     $query753 = "SELECT D_sector,daten, SUM(Number)   FROM reports where daten  between '$Thread1'   and  '$Thread2'  GROUP BY " .   D_sector . " ";
...
$query1 = mysql_query($query) or die("Query failed");
     ...
     $query10 = "SELECT * FROM  st WHERE  Thread1  between '$Thread1'   and  '$Thread2'  ORDER BY su DESC";
